...
<nav
	...
	<div class="navbar-start col-span-2 -mx-4 w-full xl:hidden">
		<div class="dropdown">
			...
			<button tabindex="0" class="menu dropdown-content rounded-box bg-base-100 z-1 mt-3 w-52 p-2 shadow-sm">
				...
				<li class="w-full rounded-lg hover:bg-red-300 focus:bg-red-300 active:bg-red-300">
					<a href="https://www.linkedin.com/in/zixianchen/">LinkedIn</a>
				</li>
				<li class="w-full rounded-lg hover:bg-red-300 focus:bg-red-300 active:bg-red-300">
					<a href="https://github.com/zachczx?tab=repositories">GitHub</a>
				</li>
				<li class="w-full rounded-lg hover:bg-red-300 focus:bg-red-300 active:bg-red-300">
					<a href="/blog">Blog</a>
				</li></button>
	...
	<div
		class="hidden h-20 w-fit min-w-120 items-center justify-center justify-self-center rounded-full border border-white/50 bg-black/70 px-2 shadow-sm backdrop-blur-md transition-all duration-300 ease-out xl:relative xl:flex">
