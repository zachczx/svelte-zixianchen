<svg viewBox="6 0.8800000000000026 52 62.21" xmlns="http://www.w3.org/2000/svg" {...$$props}
	><linearGradient id="a" x1="118.18%" x2="10.8%" y1="-2.39%" y2="101.62%"
		><stop offset="0" stop-color="#fbb743" /><stop offset="1" stop-color="#f28333" /><stop
			offset="1"
			stop-color="#ea6b00" /></linearGradient
	><g fill="none"
		><path
