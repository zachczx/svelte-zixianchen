	...
	<main>
		...
		{#if viewStatic === true}
			<section class="grid auto-cols-fr auto-rows-auto gap-7 xl:grid-cols-4">
				<div
					class="navItem card z-10 col-span-2 row-span-1 w-full border border-gray-200 bg-base-100 xl:col-span-1"
					id="side">
				...
				<div class="card col-span-2 row-span-2 border border-gray-200 bg-base-100 xl:col-span-1">
				...
				<div class="card col-span-2 row-span-2 w-full overflow-hidden border border-gray-200 bg-base-100 xl:col-span-1">
					<div class="group grid h-full items-center gap-y-5 p-4 2xl:p-6">
						<div class="space-y-8">
				...
				<div class="card card-side col-span-2 row-span-2 w-full border border-gray-200 bg-base-100 xl:col-span-1">
				...
				<div class="col-span-2 grid gap-7 xl:col-span-3 xl:grid-cols-2">
					<div class="card w-full border border-gray-200 bg-base-100">
						<div class="group grid h-full items-center gap-y-5 p-4 2xl:p-6">
							<div class="space-y-8">
