...
<div class="spectrum-background grid min-h-dvh justify-items-center">
	<!-- <div
		...
		<div class="hidden items-center justify-center space-x-8 lg:flex">
			<a
				href="/#about"
				class="btn btn-link text-xl font-medium text-base-content no-underline hover:no-underline {navCurrent == 'about'
					? 'border-b-8 border-b-gray-500'
					: 'border-b-8'}">Who am I?</a>
			<a
				href="/#career"
				class="btn btn-link text-xl font-medium text-base-content no-underline hover:no-underline {navCurrent ==
				'career'
					? 'border-b-8 border-b-gray-500'
					: 'border-b-8'}">Where have I worked?</a>
			<a
				href="/#side"
				class="btn btn-link text-xl font-medium text-base-content no-underline hover:no-underline {navCurrent == 'side'
					? 'border-b-8 border-b-gray-500'
					: 'border-b-8'}">What did I build?</a>
		</div>
	...
	<div class="max-w-screen-2xl">
		<section class="px-3 pb-2 pt-4">
			...
			<div class="navItem grid auto-cols-fr auto-rows-auto gap-7 xl:grid-cols-4" id="about">
