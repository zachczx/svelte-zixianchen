					...
					<div class="lg:flex lg:items-center lg:justify-center">
						<figure class="grid justify-items-center space-y-2">
							<figcaption>
								<a href="/projects/"
									><h3
										class="font-inter pb-1 text-center text-4xl font-normal text-[#1b510f] lg:flex lg:justify-center lg:text-6xl">
										GoRant
									</h3>
									<div class="text-center italic">Rant board imitating Reddit/Pigeonhole</div></a>
							</figcaption>
						</figure>
					</div>
				</div>
