...
<div
	...
	<div
		...
		<div class="lg:max-w-[1024px]">
			...
			<div class="view-blog-description mb-6 grid content-center justify-center">
			...
			<div class="mb-10 flex items-center justify-center text-center lg:mb-20">
				<div class="view-blog-nav border-2 border-orange-400">
					<a
						href="/blog"
						class="view-blog-blog inline-block min-w-24 border-r-2 border-r-orange-400 bg-orange-100 px-4 py-2 font-bold"
						onmouseover={() => {
							ghostColor = 'orange';
						}}
						onfocus={() => {
					...
					{#key ghostColor}<span class="inline-block min-w-20"
							><svg
								xmlns="http://www.w3.org/2000/svg"
								width="2em"
								fill={ghostColor ? ghostColor : 'currentColor'}
								height="2em"
								viewBox="0 0 24 24"
								class="icon icon-tabler icons-tabler-filled icon-tabler-ghost inline {ghostColor === 'red'
									? 'animate-right'
									: ghostColor === 'orange'
										? 'animate-left'
										: undefined}"
					...
					<a
						href="/"
						class="view-blog-home inline-block min-w-24 border-l-2 border-l-orange-400 bg-orange-100 px-4 py-2 font-bold"
						onmouseover={() => {
							ghostColor = 'red';
						}}
						onfocus={() => {
...
<style>
	* {
	...
	.view-blog-description {
		view-transition-name: view-blog-description;
	}
	.view-blog-nav {
		view-transition-name: view-blog-nav;
	}
	.view-blog-home {
		view-transition-name: view-blog-home;
	}
	.view-blog-blog {
