...
<section id="side-full" class="navItem">
	<div class="grid min-h-dvh content-center justify-items-center">
		<h2 class="">Side projects</h2>
		<div class=""><CodeTypingBro class="w-[40rem]" /></div>
	</div>
	<div class="scroll-container1 max-w-dvw grid min-h-dvh grid-cols-3 py-10">
		<div class="w-full content-center justify-self-center px-20">
			...
			<div class="mt-10 flex flex-wrap items-end justify-center space-y-4">
		...
		<div class="col-span-2 grid space-y-10 p-8">
			<div class="scroll-content1 grid max-h-36 w-2/3 justify-start">
				<h3 class="mb-4 underline decoration-lime-300 decoration-8 underline-offset-4">Problem I tried solving</h3>
				<p>
			...
			<div class="scroll-content1 grid max-h-36 w-2/3 content-center justify-self-end">
				<h3 class="mb-4 underline decoration-lime-300 decoration-8 underline-offset-4">What I wanted to do</h3>
				<p>Display lists of tech resources from Youtube, blogs, tutorials, courses, sorted by tech competency.</p>
			</div>
			<div class="scroll-content1 grid max-h-36 w-2/3 content-center justify-self-start">
				<h3 class="mb-4 underline decoration-lime-300 decoration-8 underline-offset-4">What I built</h3>
				<ul class="ml-6 list-outside list-disc marker:text-lime-300">
			...
			<div class="scroll-content1 grid max-h-36 w-2/3 content-center justify-self-end">
				<h3 class="mb-4 underline decoration-lime-300 decoration-8 underline-offset-4">Not yet done</h3>
				<p>
	...
	<div class="scroll-container2 max-w-dvw grid min-h-dvh grid-cols-3 py-10 {oddColor}">
		<div class="place-self-center px-20">
			<a href="https://appraize.zixian.dev/"
				><h3 class="text-center text-8xl font-black text-[#491eff]">Appraize</h3></a>
			<div class="mt-10 flex flex-wrap items-end justify-center space-y-4">
				<Sveltekit class="h-10 pe-6" />
		...
		<div class="col-span-2 grid space-y-6 p-8">
			<div class="scroll-content2 grid w-2/3 content-center justify-start">
			...
			<div class="scroll-content2 grid w-2/3 content-center justify-self-end">
			...
			<div class="scroll-content2 grid w-2/3 content-center justify-self-start">
	...
	<div class="scroll-container3 max-w-dvw grid min-h-dvh grid-cols-3 py-10 {evenColor}">
		...
		<div class="col-span-2 grid space-y-6 p-8">
			<div class="scroll-content3 grid w-2/3 content-center justify-start">
				...
				<p>
					...
					numbered list "1, 2, 3..." on Excel. Every change to the list required manual reordering.
				</p>
			</div>
			<div class="scroll-content3 grid w-2/3 content-center justify-self-end">
				<h3 class="mb-4 underline decoration-red-800 decoration-8 underline-offset-4">What I wanted to do</h3>
				<p>Speed up ranking sessions via drag & drop.</p>
			</div>
			<div class="scroll-content3 grid w-2/3 content-center justify-self-start">
	...
	<div class="scroll-container4 max-w-dvw grid min-h-dvh grid-cols-3 py-10 {oddColor}">
		<div class="place-self-center px-20">
		...
		<div class="col-span-2 grid space-y-6 p-8">
			<div class="scroll-content4 grid w-2/3 content-center justify-start">
			...
			<div class="scroll-content4 grid w-2/3 content-center justify-self-end">
			...
			<div class="scroll-content4 grid w-2/3 content-center justify-self-start">
	...
	<div class="scroll-container5 max-w-dvw grid min-h-dvh grid-cols-3 py-10 {evenColor}">
		<div class="place-self-center px-20">
			<div class="flex justify-center">
				<a href="https://old.btonomics.com"
					><enhanced:img src={oldBtonomicsLogo} alt="Btonomics Old Logo" class="" />
				</a>
			</div>
			<div class="mt-10 flex flex-wrap items-end justify-center space-y-4">
		...
		<div class="col-span-2 grid space-y-6 p-8">
			<div class="scroll-content5 grid w-2/3 content-center justify-start">
			...
			<div class="scroll-content5 grid w-2/3 content-center justify-self-end">
			...
			<div class="scroll-content5 grid w-2/3 content-center justify-self-start">
	...
	<div class="scroll-container6 max-w-dvw grid min-h-dvh grid-cols-3 py-10 {oddColor}">
		<div class="place-self-center px-20">
			<div class="flex justify-center">
				<h3 class="pb-4 pt-6 text-center text-7xl font-bold text-[#38bdf8]">
		...
		<div class="col-span-2 grid space-y-6 p-8">
			<div class="scroll-content6 grid w-2/3 content-center justify-start">
			...
			<div class="scroll-content6 grid w-2/3 content-center justify-self-end">
			...
			<div class="scroll-content6 grid w-2/3 content-center justify-self-start">
